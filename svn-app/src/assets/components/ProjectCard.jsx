...
export default function ProjectCard() {
    ...
    return (
        <>
            <div className="project-card-container" style={{ cursor: 'pointer' }} onClick={() => { setShowCard(true); console.log("view card") }}>
                <div style={{ display: 'flex', flexDirection: 'row', gap: '10px' }}>
                    <div style={{ fontWeight: '700', fontSize: '18px', fontFamily: '"Syne", sans-serif' }}>[Project Placeholder]</div>
            ...
            {showCard && <ViewCard onClose={() => setShowCard(false)} cardType={"project"} />}
        </>
    )
}