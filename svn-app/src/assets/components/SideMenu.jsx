...
export default function SideMenu({ role, onNavigate }) {
    function renderRoleButtons(role) {
        if (role === "admin") return (
            <>
                <div style={{ textAlign: 'left', padding: '0 0 0 15px' }}>Admin Menu</div>
        ...
        if (role === "supervisor") return (
            <>
                ...
                <button onClick={() => onNavigate('managetasks')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div className='side-menu-container'>
            ...
            <div className='sub-container'>
                <div className='overview'>
                    <div className='flex-item'>[placeholder]<subtitle>Employees</subtitle></div>
                    <div className='flex-item'>[placeholder]<subtitle>Tasks</subtitle></div>
                    <div className='flex-item'>[placeholder]<subtitle>Overdue</subtitle></div>
                    <div className='flex-item'>[placeholder]<subtitle>Due Today</subtitle></div>
                </div>
            </div>
            <div className='sub-container' style={{ flex: '1' }}>
                <div className='overview' style={{ fontSize: '18px', textAlign: 'left' }}>Instructions
